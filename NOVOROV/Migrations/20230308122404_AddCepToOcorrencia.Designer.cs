...
namespace NOVOROV.Migrations
{
    ...
    [Migration("20230308122404_AddCepToOcorrencia")]
    partial class AddCepToOcorrencia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NOVOROV.Models.AprovacaoQualidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NomeAprovacaoQualidade")
                        .IsRequired()
                        .HasColumnType("varchar(30)");

                    b.HasKey("Id");

                    b.ToTable("AprovacaoQualidade");
                });
            ...
            modelBuilder.Entity("NOVOROV.Models.DropDownLists.AprovacaoPerda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NomeAprovacaoPerda")
                        .IsRequired()
                        .HasColumnType("varchar(30)");

                    b.HasKey("Id");

                    b.ToTable("AprovacaoPerda");
                });
            ...
            modelBuilder.Entity("NOVOROV.Models.DropDownLists.Condutor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NOVOROV.Models.DropDownLists.Controle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NomeControle")
                        .IsRequired()
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("NOVOROV.Models.DropDownLists.EventoCausa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NomeEventoCausa")
                        .IsRequired()
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("NOVOROV.Models.DropDownLists.Site", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SistemaRastrementoId")
                        .HasColumnType("int");

                    b.Property<int>("SistemaRastremetoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SistemaRastrementoId");
            ...
            modelBuilder.Entity("NOVOROV.Models.DropDownLists.TipoAlarme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NomeTipoAlarme")
                        .IsRequired()
                        .HasColumnType("varchar(50)");

                    b.HasKey("Id");

                    b.ToTable("TipoAlarme");
                });
            ...
            modelBuilder.Entity("NOVOROV.Models.Ocorrencia", b =>
                {
                    ...
                    b.Property<int>("AprovacaoPerdaId")
                        .HasColumnType("int");

                    b.Property<int>("AprovacaoQualidadeId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("InformacaoOrigem")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("AprovacaoPerdaId");

                    b.HasIndex("AprovacaoQualidadeId");
            ...
            modelBuilder.Entity("NOVOROV.Models.Recuperacao", b =>
                {
                    ...
                    b.Property<int>("UsuarioValorRecuperadoPassivoId")
                        .HasColumnType("int");

                    b.Property<string>("UsuarioValorRecuperadoPassivoUsuarioId")
                        .HasColumnType("varchar(10)");
                    ...
                    b.HasIndex("UsuarioValorRecuperadoPassivoUsuarioId");
            ...
            modelBuilder.Entity("NOVOROV.Models.DropDownLists.Cmc", b =>
                {
                    b.HasOne("NOVOROV.Models.Ocorrencia", "Ocorrencia")
                        .WithOne("Cmc")
                        .HasForeignKey("NOVOROV.Models.DropDownLists.Cmc", "OcorrenciaId")
            ...
            modelBuilder.Entity("NOVOROV.Models.DropDownLists.EquipamentoPerda", b =>
                {
                    b.HasOne("NOVOROV.Models.DropDownLists.Site", "Site")
                        .WithMany()
            ...
            modelBuilder.Entity("NOVOROV.Models.DropDownLists.Site", b =>
                {
                    ...
                    b.HasOne("NOVOROV.Models.Ocorrencia", "Ocorrencia")
                        .WithOne("Site")
                        .HasForeignKey("NOVOROV.Models.DropDownLists.Site", "OcorrenciaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("NOVOROV.Models.DropDownLists.SistemaRastreamento", "SistemaRastremento")
                        .WithMany()
                        .HasForeignKey("SistemaRastrementoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("SistemaRastremento");
            ...
            modelBuilder.Entity("NOVOROV.Models.Ocorrencia", b =>
                {
                    ...
                    b.HasOne("NOVOROV.Models.DropDownLists.AprovacaoPerda", "AprovacaoPerda")
                        .WithMany()
                        .HasForeignKey("AprovacaoPerdaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NOVOROV.Models.AprovacaoQualidade", "AprovacaoQualidade")
                        .WithMany()
                        .HasForeignKey("AprovacaoQualidadeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("NOVOROV.Models.DropDownLists.Condutor", "Condutor")
                        .WithMany()
                        .HasForeignKey("CondutorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NOVOROV.Models.DropDownLists.Controle", "Controle")
                        .WithMany()
                    ...
                    b.HasOne("NOVOROV.Models.DropDownLists.EventoCausa", "EventoCausa")
                        .WithMany()
                        .HasForeignKey("EventoCausaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("NOVOROV.Models.DropDownLists.Placa", "Placa")
                        .WithMany()
                    ...
                    b.HasOne("NOVOROV.Models.DropDownLists.TipoAlarme", "TipoAlarme")
                        .WithMany()
                        .HasForeignKey("TipoAlarmeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("AprovacaoPerda");

                    b.Navigation("AprovacaoQualidade");
            ...
            modelBuilder.Entity("NOVOROV.Models.Recuperacao", b =>
                {
                    ...
                    b.HasOne("NOVOROV.Models.Usuario", "UsuarioValorRecuperadoPassivo")
                        .WithMany()
                        .HasForeignKey("UsuarioValorRecuperadoPassivoUsuarioId");
                    ...
                    b.Navigation("UsuarioValorRecuperadoPassivo");
                });
            ...
            modelBuilder.Entity("NOVOROV.Models.Ocorrencia", b =>
                {
                    b.Navigation("AlteracaoOcorrencia");
